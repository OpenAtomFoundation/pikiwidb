...
[Chinese Documentation](https://github.com/GetuiLaboratory/codis2pika/blob/main/README_zh.md)
...
codis2pika is adapted from Alibaba's open-source RedisShake project with custom modifications. Therefore, its core capabilities are generally aligned with the original tool, but there are functional differences.
