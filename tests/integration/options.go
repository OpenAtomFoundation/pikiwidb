...
const (
	...
	// PacificA一致性测试相关常量
	PACIFICA_MASTER_PORT = "9301"
	PACIFICA_SLAVE1_PORT = "9302"
	PACIFICA_SLAVE2_PORT = "9303"

	PACIFICA_MASTER_ADDR = "127.0.0.1:9301"
	PACIFICA_SLAVE1_ADDR = "127.0.0.1:9302"
	PACIFICA_SLAVE2_ADDR = "127.0.0.1:9303"
)
