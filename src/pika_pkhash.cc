...
void PKHExpireatCmd::DoThroughDB() {
  res_.clear();
  Do();
}
...
void PKHExpiretimeCmd::DoThroughDB() {
  res_.clear();
  Do();
}
...
void PKHPersistCmd::DoThroughDB() {
  res_.clear();
  Do();
}
